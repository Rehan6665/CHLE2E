...
public class CreatePatient {
	...
	public void createPatient(String Subsription, String firstname, String lastname, String email
		...
		softAssert.assertEquals( driver.findElement(By.xpath("//*[@id=\"main-body\"]/form/div/fieldset[1]/div[1]/div/span")).getText(),"The Agency Subscription field is required.");
		softAssert.assertEquals(driver.findElement(By.xpath("//*[@id=\"main-body\"]/form/div/fieldset[1]/div[5]/div/span")).getText(),"The Confirmed Email Address field is required.");
		softAssert.assertEquals(driver.findElement(By.xpath("//*[@id=\"ConfirmPasswordDiv\"]/div/span")).getText(),"The Confirmed Password field is required.");
		softAssert.assertEquals(driver.findElement(By.xpath("//*[@id=\"main-body\"]/form/div/fieldset[1]/div[8]/div/span")).getText(),"The Primary Phone Number field is required.");
		softAssert.assertEquals(driver.findElement(By.xpath("//*[@id=\"main-body\"]/form/div/div[1]/ul/li")).getText(),"Email ID already exist.");
